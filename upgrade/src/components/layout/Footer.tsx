...
async function getSocialLinks() {
	try {
		...
		const s = await SiteSettings.findOne(
			{},
			{ socialFacebook: 1, socialInstagram: 1, socialTwitter: 1, socialYoutube: 1, socialWhatsapp: 1 },
		...
		return { facebook: "", instagram: "", twitter: "", youtube: "", whatsapp: "" };
	}
}
		...
		<footer className='bg-dark text-white'>
			<div className='max-w-7xl mx-auto px-4 py-16'>
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10'>
					{/* Contact */}
					<div>
						<h4 className="text-lg font-semibold mb-4 relative after:content-[''] after:block after:w-10 after:h-0.5 after:bg-brand after:mt-2">
							Contact
						</h4>
						<ul className='space-y-2 text-gray-300 text-sm'>
							<li>Makindye Luwafu, Kampala (U)</li>
							<li>P.O. Box 29202, Kampala, Uganda</li>
							<li>
								<a
						...
						<div className='mt-4 space-y-1'>
							<a
								href='tel:+256701574447'
								className='block text-lg font-semibold hover:text-brand transition-colors'
							>
								+256 701 574 447
							</a>
							<a
								href='tel:+256786224398'
								className='block text-lg font-semibold hover:text-brand transition-colors'
							>
								+256 786 224 398
							</a>
					...
					<div>
						...
						<p className='text-sm text-gray-300 leading-relaxed'>
							Mother of Orphans is a fully incorporated community-based charity
							organization supporting orphans, widows, and vulnerable groups in
							Uganda through education, healthcare, and economic empowerment.
						</p>
						<Link
							href='/about'
					...
					<div>
						...
						<p className='text-sm text-gray-300 mb-4'>
							Subscribe to get latest news and upcoming events.
						</p>
						<NewsletterForm />
					</div>
				</div>
