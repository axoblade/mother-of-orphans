         ...
         <div class="widget-wrapper">
             <div class="row">
                 ...
                 <div class="col-lg-3 col-md-6 link-widget footer-widget">
                     ...
                     <ul>
                         <li><a href="#">One Ummah</a></li>
                         <li><a href="#">House of Zakah and Waqf Uganda</a></li>
                         <li><a href="#">Unite for Humanity</a></li>
                         <li><a href="#">Firidous Academy</a></li>
                         <li><a href="#">Awan Trust</a></li>
                     </ul>
                 </div>
                 <!-- Newsletter Widget -->
     ...
     <div class="donate-form-area">
         <div class="donate-form-wrapper">
             ...
             <form action="#" class="donate-form default-form">
                 <h3>Absa Bank Wandegeya Branch, Kampala (U)</h3>
                 <ul class="chicklet-list clearfix">
                     <li>
                         <center>UGX Account</center>
                         <label for="donate-amount-1" data-amount="10">600-6904-155</label>
                     </li>
                     <li>
                         <center>GBP Account</center>
                         <label for="donate-amount-2" data-amount="20">600-6904-171</label>
                     </li>
                     <li>
                 ...
                 <div class="contact-form">
                     <div class="row clearfix">
                         ...
                         <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             Societe Generale Paris<br>
                             Swift Code: <strong>SOGEFRPP</strong>
                         </div>
                         <div class="col-md-6 col-sm-6 col-xs-12">
                             <strong>CHF Account</strong><br>
                             Absa Bank Limited<br>
                             Swift Code: <strong>ABSAZAJJ</strong>
                         </div>
                         <div class="col-md-6 col-sm-6 col-xs-12">
                             <strong>JPY Account</strong><br>
                             Sumitomo Mitsui Banking Cooperation<br>
                             Swift Code: <strong>SMBCJPJT</strong>
                         </div>
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             <strong>ZAR Account</strong><br>
                             Absa Bank Limited<br>
                             Swift Code: <strong>ABSAZAJJ</strong>
                         </div>
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             <strong>AUD Account</strong><br>
                             Absa Bank Limited<br>
                             Swift Code: <strong>ABSAZAJJ</strong>
                         </div>
